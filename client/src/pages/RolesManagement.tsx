                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="min-w-0 flex-1">
                          <div className="font-medium text-xs truncate">{permission.name}</div>
                          <div className="text-[10px] text-muted-foreground leading-tight">{permission.description}</div>
                        </div>
                        {formData.permissions.includes(permission.id) ? (
                          <Check className="h-3 w-3 text-primary ml-1 flex-shrink-0" />
                        ) : (
                          <X className="h-3 w-3 text-muted-foreground ml-1 flex-shrink-0" />
                        )}
                      </div>
                    </div>
                  ))}
